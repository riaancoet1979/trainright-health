...
// Generated by garmin_sync.py (locally or by the .github/workflows/garmin-sync.yml
// cron) and bundled into the GitHub Pages artifact. The two callsites — this
// fetch and garmin_sync.py's output — MUST match. Anyone with the JS bundle
// can derive this URL; obscurity is not a privacy mechanism, see audit/.
